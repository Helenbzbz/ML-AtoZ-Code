...
def create_post():
    ...
    return render_template("make-post.html", form = create_post_form, is_edit = False)
...
def edit_post(post_id):
    ...
    return render_template("make-post.html", post_id = post_id, is_edit = True, form = edit_form)
